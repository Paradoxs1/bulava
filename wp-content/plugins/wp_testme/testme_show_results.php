...
if (get_option('testme_stat_allow') == 'yes') {        
	...
	?>
<div class='testme_code'><p><b>Прошел тест? Предложи друзьям на форуме:</b></p>
<textarea>

Здесь вставьте что-нибудь
    ...
    if (get_option("testme_code_for_blog")== 'yes') {
		?>
<div class='testme_code'><p><b>HTML-код для размещения на вашем блоге:</b></p>
<textarea>

И здесь тоже что-то надо вставить.
